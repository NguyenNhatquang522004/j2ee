                ...
                <div className="pt-10 border-t border-[#dae5e0] flex flex-col gap-10">
                    ...
                    <div className="flex flex-wrap justify-center md:justify-between items-center gap-12 py-10 px-14 bg-white/60 rounded-[3rem] border border-[#dae5e0] shadow-sm group backdrop-blur-sm relative overflow-hidden">
                        ...
                        <div className="flex items-center gap-5 relative z-10">
                            ...
                            <div>
                                ...
                                <p className="font-black text-[#1a3c31] text-2xl tracking-tight">1900 1234</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-5 relative z-10">
                            ...
                            <div>
                                ...
                                <p className="font-black text-[#1a3c31] text-lg">support@freshfood.vn</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-5 relative z-10">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-black text-[#4a6d5f]">Cầu Giấy, Hà Nội</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-wrap justify-between items-center gap-6 text-[10px] font-black tracking-[0.2em] text-[#5a7d6e]/40 px-6">
                        <div className="flex items-center gap-3">
                            ...
                            <p className="uppercase">© 2026 FRESHFOOD ECO-SYSTEM. ALL RIGHTS RESERVED.</p>
                        </div>
...
const SocialIcon = ({ children }) => (
    <a href="#" className="w-12 h-12 rounded-3xl bg-white border border-[#dae5e0] flex items-center justify-center text-[#1a3c31] hover:bg-[#1a3c31] hover:text-white transition-all shadow-sm hover:-translate-y-1">
        {children}
    </a>
);
